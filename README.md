...
> - Pi: install [`@earendil-works/pi-coding-agent`](https://github.com/earendil-works/pi-coding-agent) (`npm i -g @earendil-works/pi-coding-agent`), then enable it in Settings and set the binary path if needed.
